...
public abstract class BaseBakedModel implements IBakedModel {
	...
	protected ArrayList<BakedQuad> createBoxWithZRotation(double lowerX, double lowerY, double lowerZ, double width, double height, int depth, int rotation, BoxTextureCollection collection, EnumFacing facing)
	{
		ArrayList<BakedQuad> retVal = new ArrayList<BakedQuad>();
